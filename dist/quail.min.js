...
var Client = /** @class */ (function () {
    ...
    Client.prototype.subscribeWithChallenge = function (list_id, email, params) {
        var payload = { email: email, "challenge-provider": params["challenge-provider"] };
        ...
        return this.request("/subscriptions/".concat(list_id), "POST", payload);
    };
    ...
    Client.prototype.incCount = function (post_id, field, utmParams) {
        if (utmParams === void 0) { utmParams = null; }
        var url = "/posts/".concat(field, "?id=").concat(post_id);
        if (utmParams && typeof utmParams === "object") {
            var utmQueryParams = Object.entries(utmParams)
                .filter(function (_a) {
                _a[0]; var value = _a[1];
